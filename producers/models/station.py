...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = "com.udacity.cta.station.arrivals.v1" #f"{station_name}" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        logger.info("Info-station.py: producing arrival message to Kafka completed")
