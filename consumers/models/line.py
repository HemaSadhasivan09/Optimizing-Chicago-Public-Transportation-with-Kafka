...
class Line:
    ...
    def process_message(self, message):
        ...
        if message.topic() == "com.udacity.cta.station.table.v1": # Set the conditional correctly to the stations Faust Table
            try:
        ...
        elif message.topic() == "com.udacity.cta.station.arrivals.v1": # Set the conditional to the arrival topic
